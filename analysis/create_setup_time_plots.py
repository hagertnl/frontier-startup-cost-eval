...
# This script requires `setup_times.csv`, generated by `create_setup_times_csv.sh`
...
for index, entry in df_grouped[['benchmark', 'tool']].drop_duplicates().iterrows():
    single_series_df = df_grouped[(df_grouped['benchmark'] == entry['benchmark']) & (df_grouped['tool'] == entry['tool'])]
